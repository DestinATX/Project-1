6/9/20 (Tuesday) Met during class.  Redefining final delivery and modifying MVP to ensure coding supports. Plan to finalize readme files, update storyboard if needed, phase review update, and plan to develop presentation with demo.  Still need to create several deliv erables like user stories, demo, code samples, etc.
6/8/20 (Monday) Met during class to finalize plans to pull delivery of data into results and solution.  Directions is still being worked and delivery of directions still WIP.  Worked on header or navbar/footer and sidenav.
