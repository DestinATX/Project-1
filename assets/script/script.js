        ...
        $.ajax({
          ...
          $("#submit").on("click", function () {
            ...
            $.ajax({
              ...
              // destiation = getYelpApi.businesses[0].location.display_address[0] + " " + getYelpApi.businesses[0].location.display_address[1];
      ...
      function (position) {
        ...
        $.ajax({
          ...
          var queryURL =
            "https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/directions/json?origin=" +
            origin +
            "&destination=Garden+of+the+gods&mode=driving&key=AIzaSyAHeXe0OoBIReOvCuEJq5cnU3LhVahYTAk";
          $.ajax({
            url: queryURL,
            method: "GET",
            dataType: "json",
